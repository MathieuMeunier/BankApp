...
class AccountDetailViewModelTests {
    ...
    private lateinit var accountDetailViewModel: AccountDetailViewModelImpl
    ...
    fun beforeEach() {
        ...
        accountDetailViewModel = AccountDetailViewModelImpl(repository)
    ...
    fun getAccount_should_return_data() = runTest(UnconfinedTestDispatcher()) {
        ...
        launch(Dispatchers.Main) { accountDetailViewModel.getAccount("151515151151") }

        assertEquals(accountDetailViewModel.account.getOrAwaitValue(), TestHelper.Data.dataAccountStateResult)
    }
